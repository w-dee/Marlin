 ...
 * 0 = No Power Switch
 * 1 = ATX
 * 2 = X-Box 360 203Watts (the blue wire connected to PS_ON and the red wire to VCC)5
 *
...
// My setting
#define DEFAULT_Kp 6.79
#define DEFAULT_Ki 0.36
#define DEFAULT_Kd 200.08
  // MakerGear
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (MAX_PROBE_X - 40)
  #define FRONT_PROBE_BED_POSITION (MIN_PROBE_Y + 8)
  #define BACK_PROBE_BED_POSITION  (MAX_PROBE_Y - 8)
